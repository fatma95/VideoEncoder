...
//extension ImagePickerView {
    class EncodeViewModel: ObservableObject {
        ...
        func encodeVideo(videoToCompress: URL, destinationPath: URL, size: CompressionSize?, compressionTransform: CompressionTransform, compressionConfig: CompressionConfig, completionHandler: @escaping (URL)->(), errorHandler: @escaping (Error)->(), cancelHandler: @escaping ()->(), framesDone: @escaping (Double) -> ()) -> CancelableCompression {
            ...
            do {
                ...
                compressQueue.async {
                    ...
                    while !videoDone || !audioDone {
                        ...
                        print(CMTimeGetSeconds(avAsset.duration))
